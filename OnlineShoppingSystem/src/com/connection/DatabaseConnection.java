...
public class DatabaseConnection {
	...
	public static Connection getConnection() {
		try {
			...
			//connection = DriverManager.getConnection("jdbc:mysql://localhost/nit?useSSL=false", "root", "0615565968Bashir");
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/bayansofnew_onlineshoppingsystem?useSSL=false", "siidi", "0615565968");
